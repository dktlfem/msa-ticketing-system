...
> 파티셔닝 전략, 인덱스 체크리스트 등 설계 원칙은 [`docs/03-database-cache-design.md`](../03-database-cache-design.md)를 참고합니다.
...
*최종 업데이트: 2026-03-16 | PaymentEntity.java, IdempotencyManager.java 구현 반영*
