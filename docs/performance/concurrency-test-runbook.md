---
title: "07. 성능 / 동시성 테스트 및 Enablement Runbook"
last_updated: 2026-03-19
author: "민석"
reviewer: ""
---

> **[안내]** 이 문서는 Java `CountDownLatch` 기반 동시성 부하 테스트를 다룹니다.
> k6 기반 부하 테스트(시나리오 스크립트, VU 단계 조정, CSV/Excel 결과 저장)는
> [`performance/performance-test-runbook.md`](performance/performance-test-runbook.md)를 참고하세요.

## 목차
- [1. 왜 이 문서가 중요한가](#1-왜-이-문서가-중요한가)
- [2. 테스트 원칙](#2-테스트-원칙)
- [3. 100 스레드 CountDownLatch 시나리오](#3-100-스레드-countdownlatch-시나리오)
- [3.1 공통 패턴](#31-공통-패턴)
- [4. 권장 시나리오](#4-권장-시나리오)
- [시나리오 A. 같은 좌석에 100명 예약 생성](#시나리오-a-같은-좌석에-100명-예약-생성)
- [시나리오 B. 같은 reservation에 confirm 100개](#시나리오-b-같은-reservation에-confirm-100개)
- [시나리오 C. cancel 100개](#시나리오-c-cancel-100개)
- [5. 권장 판정 기준](#5-권장-판정-기준)
- [5.1 응답 기준](#51-응답-기준)
- [5.2 데이터 기준](#52-데이터-기준)
- [5.3 관측성 기준](#53-관측성-기준)
- [6. 실행 체크리스트](#6-실행-체크리스트)
- [7. SQL 확인 예시](#7-sql-확인-예시)
- [8. 트러블슈팅 문서에 꼭 넣을 것](#8-트러블슈팅-문서에-꼭-넣을-것)
- [9. Enablement 산출물 권장 목록](#9-enablement-산출물-권장-목록)
- [10. 다음 단계](#10-다음-단계)
