...
public class WaitingRoomController {
    ...
    @PostMapping("/join")
    public ResponseEntity<WaitingRoomResponseDTO> joinWaitingRoom(@RequestBody @Valid WaitingRoomRequestDTO request) {
    ...
    @GetMapping("/status")
    public ResponseEntity<WaitingRoomResponseDTO> checkStatus(
